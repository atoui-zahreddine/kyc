...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './applicant-addresse.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_APPLICANTADDRESSE_LIST actions', async () => {
    ...
    it('dispatches FETCH_APPLICANTADDRESSE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_APPLICANTADDRESSE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_APPLICANTADDRESSE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_APPLICANTADDRESSE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_APPLICANTADDRESSE actions', async () => {
      const expectedActions = [
        {
