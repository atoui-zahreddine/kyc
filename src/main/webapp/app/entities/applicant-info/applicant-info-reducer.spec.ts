...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_APPLICANTINFO_LIST actions', async () => {
    ...
    it('dispatches FETCH_APPLICANTINFO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_APPLICANTINFO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_APPLICANTINFO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_APPLICANTINFO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_APPLICANTINFO actions', async () => {
      const expectedActions = [
        {
