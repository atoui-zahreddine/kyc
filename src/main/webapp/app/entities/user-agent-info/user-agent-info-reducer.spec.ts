...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_USERAGENTINFO_LIST actions', async () => {
    ...
    it('dispatches FETCH_USERAGENTINFO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_USERAGENTINFO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_USERAGENTINFO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_USERAGENTINFO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_USERAGENTINFO actions', async () => {
      const expectedActions = [
        {
