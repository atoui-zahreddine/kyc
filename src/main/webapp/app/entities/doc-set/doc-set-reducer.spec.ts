...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './doc-set.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DOCSET_LIST actions', async () => {
    ...
    it('dispatches FETCH_DOCSET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_DOCSET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_DOCSET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_DOCSET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_DOCSET actions', async () => {
      const expectedActions = [
        {
