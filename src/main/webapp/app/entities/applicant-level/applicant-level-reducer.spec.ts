...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_APPLICANTLEVEL_LIST actions', async () => {
    ...
    it('dispatches FETCH_APPLICANTLEVEL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_APPLICANTLEVEL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_APPLICANTLEVEL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_APPLICANTLEVEL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_APPLICANTLEVEL actions', async () => {
      const expectedActions = [
        {
