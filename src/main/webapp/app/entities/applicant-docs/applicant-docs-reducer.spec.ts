...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_APPLICANTDOCS_LIST actions', async () => {
    ...
    it('dispatches FETCH_APPLICANTDOCS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_APPLICANTDOCS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_APPLICANTDOCS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_APPLICANTDOCS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_APPLICANTDOCS actions', async () => {
      const expectedActions = [
        {
