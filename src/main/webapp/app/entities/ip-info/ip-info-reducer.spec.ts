...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './ip-info.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_IPINFO_LIST actions', async () => {
    ...
    it('dispatches FETCH_IPINFO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_IPINFO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_IPINFO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_IPINFO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_IPINFO actions', async () => {
      const expectedActions = [
        {
