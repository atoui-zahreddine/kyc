...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_APPLICANTPHONE_LIST actions', async () => {
    ...
    it('dispatches FETCH_APPLICANTPHONE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_APPLICANTPHONE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_APPLICANTPHONE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_APPLICANTPHONE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_APPLICANTPHONE actions', async () => {
      const expectedActions = [
        {
